...
<fieldset>
	...
	<display:table name="stadisticsreceivedChirpsPerChorbi" id="row"
...
<fieldset>
	<legend>
		<b><spring:message code="dashboard.stadisticsSentChirpsPerChorbi" /></b>
	</legend>

	<jstl:set var="i" value="0"></jstl:set>
	<display:table name="stadisticsSentChirpsPerChorbi" id="row"
		requestURI="administrator/dashboardA" class="displaytag">
		<spring:message code="dashboard.statistics" var="statistics" />
		<display:column title="${statistics}">
			<jstl:choose>
