...
public class ChorbiService {
	...
	public Collection<ChorbiListForm> findChorbisFromAuthorWithLikes(int authorId) {
	...
	public Collection<ChorbiListForm> findChorbisFromReceiverWithLikes(int receiverId) {
		Collection<ChorbiListForm> result;
		Actor principal;
